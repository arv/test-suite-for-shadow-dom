...
test(unit(function (ctx) {
    ...
    assert_true(isVisible(d.querySelector('#shadow')), '\'details\' should allow at least one insertion point');
...
test(unit(function (ctx) {
    ...
    assert_true(isVisible(d.querySelector('#shadow')), 'details should allow insertion point' +
