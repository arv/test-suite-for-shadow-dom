...
test(function () {
    ...
    assert_true(widget.webkitPseudo != null, 'attribute \'pseudo\' must not be null');
    
    assert_equals(widget.webkitPseudo, '', 'attribute \'pseudo\' must return ' +
    		'empty string if there is no custom pseudo-element associated with this element')
        
}, 'A_10_02_02_T01', PROPS(A_10_02_02, {
...
}, 'A_10_02_02_T02', PROPS(A_10_02_02, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
