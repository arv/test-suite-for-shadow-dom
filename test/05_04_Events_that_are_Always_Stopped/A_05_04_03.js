...
var A_05_04_03_T02 = async_test('A_05_04_03_T02', PROPS(A_05_04_03, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));

A_05_04_03_T02.step(unit(function (ctx) {	
	...
	s.appendChild(shadowDiv);
	 ...
	 s.addEventListener('select', A_05_04_03_T02.step_func(function(event) {
	 	assert_equals(event.target.getAttribute('id'), 'inp1', 'Inside shadow tree: Wrong target');  	
	 }), false);
	 
	 
	 var invoked = false;     
	 d.body.addEventListener('select', A_05_04_03_T02.step_func(function(event) {
	 	invoked = true;
	 }), false);
	 ...
	 assert_true(invoked, 'Select event should not be stopped at Shadow boundary for distributed nodes');
