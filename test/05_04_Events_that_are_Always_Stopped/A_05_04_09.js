...
var A_05_04_09_T02 = async_test('A_05_04_09_T02', PROPS(A_05_04_09, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));

A_05_04_09_T02.step(unit(function (ctx) {	
	...
	s.appendChild(shadowDiv);
	 ...
	 s.addEventListener('selectstart', A_05_04_09_T02.step_func(function(event) {
	 	assert_equals(event.target.getAttribute('id'), 'inp1', 'Inside shadow tree: Wrong target');  	
	 }), false);
	 
	 
	 var invoked = false;     
	 d.body.addEventListener('selectstart', A_05_04_09_T02.step_func(function(event) {
	 	invoked = true;
	 }), false);
	 ...
	 assert_true(invoked, 'Selectstart event should not be stopped at Shadow boundary for distributed nodes');
